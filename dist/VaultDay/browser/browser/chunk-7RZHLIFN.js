...
var CountdownService = class _CountdownService {
  countdownSubject = new BehaviorSubject({ hours: 0, minutes: 0, seconds: 0, totalSeconds: 0 });
  timezoneOffset = 0;
  // Will be set based on IP
  timerInterval;
  constructor() {
    ...
    return __async(this, null, function* () {
      try {
        ...
        if (data.timezone) {
          ...
          this.timezoneOffset = (localTime.getTime() - utc.getTime()) / 6e4;
  ...
  static \u0275fac = function CountdownService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CountdownService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _CountdownService, factory: _CountdownService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CountdownService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
// src/app/components/countdown-timer/countdown-timer.ts
var CountdownTimerComponent = class _CountdownTimerComponent {
  countdownService;
  countdownTime = { hours: 0, minutes: 0, seconds: 0, totalSeconds: 0 };
  subscription = new Subscription();
  constructor(countdownService) {
    this.countdownService = countdownService;
  }
  ngOnInit() {
    this.subscription = this.countdownService.getCountdown().subscribe((time) => {
  ...
  static \u0275fac = function CountdownTimerComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CountdownTimerComponent)(\u0275\u0275directiveInject(CountdownService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CountdownTimerComponent, selectors: [["app-countdown-timer"]], decls: 18, vars: 12, consts: [[1, "countdown-container"], [1, "countdown-display"], [1, "time-unit"], [1, "time-value"], [1, "time-separator"]], template: function CountdownTimerComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(7, ":");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(8, "div", 2)(9, "span", 3);
      \u0275\u0275text(10);
      \u0275\u0275pipe(11, "number");
      \u0275\u0275domElementEnd()();
      ...
      \u0275\u0275text(13, ":");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(14, "div", 2)(15, "span", 3);
      \u0275\u0275text(16);
      \u0275\u0275pipe(17, "number");
      \u0275\u0275domElementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(5, 3, ctx.countdownTime.hours, "2.0-0"));
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(11, 6, ctx.countdownTime.minutes, "2.0-0"));
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(17, 9, ctx.countdownTime.seconds, "2.0-0"));
    }
  }, dependencies: [CommonModule, DecimalPipe], styles: ['\n\n.countdown-container[_ngcontent-%COMP%] {\n  position: relative;\n  background:\n    linear-gradient(\n      135deg,\n      #0a0a0a 0%,\n      #1a1a2e 50%,\n      #16213e 100%);\n  border-radius: 20px;\n  padding: 40px 60px;\n  text-align: center;\n  overflow: hidden;\n  box-shadow:\n    0 0 30px rgba(0, 255, 255, 0.3),\n    0 0 60px rgba(255, 0, 255, 0.2),\n    0 0 90px rgba(255, 100, 0, 0.1);\n  animation: _ngcontent-%COMP%_cosmicGlow 4s ease-in-out infinite;\n}\n.countdown-container[_ngcontent-%COMP%]::before {\n  content: "";\n  position: absolute;\n  top: -2px;\n  left: -2px;\n  right: -2px;\n  bottom: -2px;\n  background:\n    linear-gradient(\n      45deg,\n      #00ffff 0%,\n      #0080ff 25%,\n      #ff0080 50%,\n      #ff4000 75%,\n      #8000ff 100%);\n  border-radius: 22px;\n  z-index: -1;\n  animation: _ngcontent-%COMP%_neonRotate 3s linear infinite;\n}\n.countdown-container[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background:\n    radial-gradient(\n      circle at 20% 20%,\n      rgba(0, 255, 255, 0.1) 0%,\n      transparent 50%),\n    radial-gradient(\n      circle at 80% 80%,\n      rgba(255, 0, 128, 0.1) 0%,\n      transparent 50%),\n    radial-gradient(\n      circle at 40% 60%,\n      rgba(255, 100, 0, 0.05) 0%,\n      transparent 50%);\n  border-radius: 20px;\n  pointer-events: none;\n}\n.countdown-display[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 20px;\n  position: relative;\n  z-index: 1;\n}\n.countdown-display[_ngcontent-%COMP%]   .time-unit[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: rgba(0, 0, 0, 0.3);\n  border-radius: 12px;\n  padding: 0;\n  -webkit-backdrop-filter: blur(10px);\n  backdrop-filter: blur(10px);\n  border: 1px solid rgba(255, 255, 255, 0.1);\n  width: 80px;\n  height: 80px;\n  min-width: 80px;\n  min-height: 80px;\n  position: relative;\n  overflow: hidden;\n}\n.countdown-display[_ngcontent-%COMP%]   .time-unit[_ngcontent-%COMP%]   .time-value[_ngcontent-%COMP%] {\n  font-size: 48px;\n  font-weight: 700;\n  color: #e0e0e0;\n  text-shadow:\n    0 0 10px rgba(255, 255, 255, 0.5),\n    0 0 20px rgba(255, 255, 255, 0.3),\n    0 0 30px rgba(255, 255, 255, 0.1);\n  font-family: "Poppins", monospace;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  line-height: 1;\n  white-space: nowrap;\n  letter-spacing: 2px;\n}\n.countdown-display[_ngcontent-%COMP%]   .time-separator[_ngcontent-%COMP%] {\n  font-size: 48px;\n  font-weight: 700;\n  color: #e0e0e0;\n  text-shadow: 0 0 10px rgba(255, 255, 255, 0.5), 0 0 20px rgba(255, 255, 255, 0.3);\n  margin: 0 5px;\n  animation: _ngcontent-%COMP%_separatorPulse 2s ease-in-out infinite;\n}\n@keyframes _ngcontent-%COMP%_cosmicGlow {\n  0%, 100% {\n    box-shadow:\n      0 0 30px rgba(0, 255, 255, 0.3),\n      0 0 60px rgba(255, 0, 255, 0.2),\n      0 0 90px rgba(255, 100, 0, 0.1);\n  }\n  50% {\n    box-shadow:\n      0 0 40px rgba(255, 0, 255, 0.4),\n      0 0 80px rgba(255, 100, 0, 0.3),\n      0 0 120px rgba(0, 255, 255, 0.2);\n  }\n}\n@keyframes _ngcontent-%COMP%_neonRotate {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n@keyframes _ngcontent-%COMP%_separatorPulse {\n  0%, 100% {\n    opacity: 1;\n    transform: scale(1);\n  }\n  50% {\n    opacity: 0.7;\n    transform: scale(1.1);\n  }\n}\n@media (max-width: 768px) {\n  .countdown-container[_ngcontent-%COMP%] {\n    padding: 30px 40px;\n  }\n  .countdown-display[_ngcontent-%COMP%] {\n    gap: 15px;\n  }\n  .countdown-display[_ngcontent-%COMP%]   .time-unit[_ngcontent-%COMP%] {\n    width: 70px;\n    height: 70px;\n    min-width: 70px;\n    min-height: 70px;\n  }\n  .countdown-display[_ngcontent-%COMP%]   .time-unit[_ngcontent-%COMP%]   .time-value[_ngcontent-%COMP%] {\n    font-size: 36px;\n  }\n  .countdown-display[_ngcontent-%COMP%]   .time-separator[_ngcontent-%COMP%] {\n    font-size: 36px;\n  }\n}\n@media (max-width: 480px) {\n  .countdown-container[_ngcontent-%COMP%] {\n    padding: 20px 30px;\n  }\n  .countdown-display[_ngcontent-%COMP%] {\n    gap: 10px;\n  }\n  .countdown-display[_ngcontent-%COMP%]   .time-unit[_ngcontent-%COMP%] {\n    width: 60px;\n    height: 60px;\n    min-width: 60px;\n    min-height: 60px;\n  }\n  .countdown-display[_ngcontent-%COMP%]   .time-unit[_ngcontent-%COMP%]   .time-value[_ngcontent-%COMP%] {\n    font-size: 28px;\n  }\n  .countdown-display[_ngcontent-%COMP%]   .time-separator[_ngcontent-%COMP%] {\n    font-size: 28px;\n  }\n}\n/*# sourceMappingURL=countdown-timer.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CountdownTimerComponent, [{
    type: Component,
    args: [{ selector: "app-countdown-timer", imports: [CommonModule], template: `
  ...
  `, styles: ['/* angular:styles/component:scss;4b8038da80b15119257d90998f619440d7e1df4b30eefb72eaf46eaade329173;/Users/aidenpham/Documents/GitHub/Vaultday/src/app/components/countdown-timer/countdown-timer.ts */\n.countdown-container {\n  position: relative;\n  background:\n    linear-gradient(\n      135deg,\n      #0a0a0a 0%,\n      #1a1a2e 50%,\n      #16213e 100%);\n  border-radius: 20px;\n  padding: 40px 60px;\n  text-align: center;\n  overflow: hidden;\n  box-shadow:\n    0 0 30px rgba(0, 255, 255, 0.3),\n    0 0 60px rgba(255, 0, 255, 0.2),\n    0 0 90px rgba(255, 100, 0, 0.1);\n  animation: cosmicGlow 4s ease-in-out infinite;\n}\n.countdown-container::before {\n  content: "";\n  position: absolute;\n  top: -2px;\n  left: -2px;\n  right: -2px;\n  bottom: -2px;\n  background:\n    linear-gradient(\n      45deg,\n      #00ffff 0%,\n      #0080ff 25%,\n      #ff0080 50%,\n      #ff4000 75%,\n      #8000ff 100%);\n  border-radius: 22px;\n  z-index: -1;\n  animation: neonRotate 3s linear infinite;\n}\n.countdown-container::after {\n  content: "";\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background:\n    radial-gradient(\n      circle at 20% 20%,\n      rgba(0, 255, 255, 0.1) 0%,\n      transparent 50%),\n    radial-gradient(\n      circle at 80% 80%,\n      rgba(255, 0, 128, 0.1) 0%,\n      transparent 50%),\n    radial-gradient(\n      circle at 40% 60%,\n      rgba(255, 100, 0, 0.05) 0%,\n      transparent 50%);\n  border-radius: 20px;\n  pointer-events: none;\n}\n.countdown-display {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 20px;\n  position: relative;\n  z-index: 1;\n}\n.countdown-display .time-unit {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: rgba(0, 0, 0, 0.3);\n  border-radius: 12px;\n  padding: 0;\n  -webkit-backdrop-filter: blur(10px);\n  backdrop-filter: blur(10px);\n  border: 1px solid rgba(255, 255, 255, 0.1);\n  width: 80px;\n  height: 80px;\n  min-width: 80px;\n  min-height: 80px;\n  position: relative;\n  overflow: hidden;\n}\n.countdown-display .time-unit .time-value {\n  font-size: 48px;\n  font-weight: 700;\n  color: #e0e0e0;\n  text-shadow:\n    0 0 10px rgba(255, 255, 255, 0.5),\n    0 0 20px rgba(255, 255, 255, 0.3),\n    0 0 30px rgba(255, 255, 255, 0.1);\n  font-family: "Poppins", monospace;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  line-height: 1;\n  white-space: nowrap;\n  letter-spacing: 2px;\n}\n.countdown-display .time-separator {\n  font-size: 48px;\n  font-weight: 700;\n  color: #e0e0e0;\n  text-shadow: 0 0 10px rgba(255, 255, 255, 0.5), 0 0 20px rgba(255, 255, 255, 0.3);\n  margin: 0 5px;\n  animation: separatorPulse 2s ease-in-out infinite;\n}\n@keyframes cosmicGlow {\n  0%, 100% {\n    box-shadow:\n      0 0 30px rgba(0, 255, 255, 0.3),\n      0 0 60px rgba(255, 0, 255, 0.2),\n      0 0 90px rgba(255, 100, 0, 0.1);\n  }\n  50% {\n    box-shadow:\n      0 0 40px rgba(255, 0, 255, 0.4),\n      0 0 80px rgba(255, 100, 0, 0.3),\n      0 0 120px rgba(0, 255, 255, 0.2);\n  }\n}\n@keyframes neonRotate {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n@keyframes separatorPulse {\n  0%, 100% {\n    opacity: 1;\n    transform: scale(1);\n  }\n  50% {\n    opacity: 0.7;\n    transform: scale(1.1);\n  }\n}\n@media (max-width: 768px) {\n  .countdown-container {\n    padding: 30px 40px;\n  }\n  .countdown-display {\n    gap: 15px;\n  }\n  .countdown-display .time-unit {\n    width: 70px;\n    height: 70px;\n    min-width: 70px;\n    min-height: 70px;\n  }\n  .countdown-display .time-unit .time-value {\n    font-size: 36px;\n  }\n  .countdown-display .time-separator {\n    font-size: 36px;\n  }\n}\n@media (max-width: 480px) {\n  .countdown-container {\n    padding: 20px 30px;\n  }\n  .countdown-display {\n    gap: 10px;\n  }\n  .countdown-display .time-unit {\n    width: 60px;\n    height: 60px;\n    min-width: 60px;\n    min-height: 60px;\n  }\n  .countdown-display .time-unit .time-value {\n    font-size: 28px;\n  }\n  .countdown-display .time-separator {\n    font-size: 28px;\n  }\n}\n/*# sourceMappingURL=countdown-timer.css.map */\n'] }]
  }], () => [{ type: CountdownService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CountdownTimerComponent, { className: "CountdownTimerComponent", filePath: "src/app/components/countdown-timer/countdown-timer.ts", lineNumber: 212 });
})();
...
var SupabaseService = class _SupabaseService {
  ...
  testConnection() {
    return __async(this, null, function* () {
      try {
        const response = yield fetch("/.netlify/functions/test-neon", {
          method: "GET",
          headers: {
  ...
  runDailyCleanup() {
    return __async(this, null, function* () {
      try {
        const response = yield fetch("/.netlify/functions/daily-cleanup", {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
          }
  ...
  getPublicRooms() {
    return __async(this, null, function* () {
      ...
      `;
        const result = yield this.queryDatabase(query);
